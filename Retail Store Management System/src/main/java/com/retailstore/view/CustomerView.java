...
import com.retailstore.util.ButtonColumn;
...
public class CustomerView extends JFrame {
    ...
    public CustomerView() {
        ...
        this.setTitle(config.getAppName() + " - Welcome");
    ...
    private JPanel createHeaderPanel() {
        ...
        welcomeLabel.setFont(new Font(config.getDefaultFont(), Font.BOLD, config.getTitleFontSize()));
        ...
        catalogTable.addMouseMotionListener(new MouseMotionAdapter() {
            public void mouseMoved(MouseEvent e) {
                ...
                if (row >= 0) {
                    ...
                    com.retailstore.model.Product product = Application.getInstance().getDataAdapter().loadProduct(productId);
    ...
    private JPanel createFooterPanel() {
        ...
        btnBuy.setFont(new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize()));
    ...
    public void loadCatalogData() {
        try {
            // Get current user
            com.retailstore.model.Users currentUser = Application.getInstance().getCurrentUser();
            if (currentUser != null) {
