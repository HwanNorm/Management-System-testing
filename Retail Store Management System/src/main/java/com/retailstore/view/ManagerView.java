...
public class ManagerView extends JFrame {
    ...
    public ManagerView() {
        ...
        this.setTitle(config.getAppName() + " - Manager View");
    ...
    private JPanel createRedisAnalyticsPanel() {
        ...
        bestProductsTable.getTableHeader().setFont(new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize()));
        bestProductsTable.setFont(new Font(config.getDefaultFont(), Font.PLAIN, config.getDefaultFontSize()));
        ...
        recentCustomersTable.getTableHeader().setFont(new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize()));
        recentCustomersTable.setFont(new Font(config.getDefaultFont(), Font.PLAIN, config.getDefaultFontSize()));
    ...
    private void refreshRedisAnalytics(DefaultTableModel productsModel, DefaultTableModel customersModel) {
        ...
        List<RedisDataAdapter.ProductSalesData> bestProducts = redis.getBestSellingProducts(config.getBestProductsLimit());
        ...
        List<RedisDataAdapter.RecentCustomerData> recentCustomers = redis.getRecentCustomers(config.getRecentCustomersLimit());
