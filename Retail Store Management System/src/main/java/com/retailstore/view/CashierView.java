...
public class CashierView extends JFrame {
    ...
    public CashierView() {
        ...
        this.setTitle(config.getAppName() + " - Cashier View");
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setSize(config.getDefaultWindowWidth(), config.getDefaultWindowHeight());
    ...
    private void initializeComponents() {
        ...
        Font buttonFont = new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize());

        barcodeField = new JTextField(20);
        barcodeField.setPreferredSize(new Dimension(200, 35));
        barcodeField.setFont(new Font(config.getDefaultFont(), Font.PLAIN, config.getDefaultFontSize() + 2));
        ...
        paymentMethodLabel.setFont(new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize() + 2));
        ...
        Font summaryFont = new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize() + 2);
        labSubtotal = new JLabel("Subtotal: $0.00");
        labTax = new JLabel("Tax (" + (int)(config.getTaxRate() * 100) + "%): $0.00");
    ...
    private JPanel createCartPanel() {
        ...
        cartPanel.setBorder(BorderFactory.createTitledBorder(
                ...
                TitledBorder.LEFT,
                TitledBorder.TOP,
                new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize() + 2)));
    ...
    private void setupTableProperties() {
        ...
        cartTable.getTableHeader().setFont(new Font(config.getDefaultFont(), Font.BOLD, config.getDefaultFontSize()));
        cartTable.setFont(new Font(config.getDefaultFont(), Font.PLAIN, config.getDefaultFontSize()));
        ...
        Font tableFont = new Font("Dialog", Font.PLAIN, config.getDefaultFontSize());
        ...
        cartTable.getColumnModel().getColumn(5).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (value != null && value.toString().contains("✓")) {
                    setFont(new Font("Dialog", Font.PLAIN, config.getDefaultFontSize() + 2));
                }
                return this;
            }
        });
    ...
    public void updateTotals(double subtotal, double tax, double total) {
        ...
        labTax.setText(String.format("Tax (%d%%): $%.2f", (int)(config.getTaxRate() * 100), tax));
