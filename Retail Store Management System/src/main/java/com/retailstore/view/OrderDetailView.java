...
public class OrderDetailView extends JDialog {
    ...
    private void initializeComponents() {
        ...
        labTax = new JLabel("Tax (" + (int)(Application.getInstance().getConfig().getTaxRate() * 100) + "%): $0.00", SwingConstants.RIGHT);
    ...
    public void displayOrderDetails(Orders order, DataAdapter dataAdapter) {
        ...
        labTax.setText(String.format("Tax (%d%%): $%,.2f", (int)(Application.getInstance().getConfig().getTaxRate() * 100), tax));
